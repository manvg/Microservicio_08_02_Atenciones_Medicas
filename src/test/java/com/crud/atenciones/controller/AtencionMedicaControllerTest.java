...
public class AtencionMedicaControllerTest {
    ...
    public void getAllAtencionesMedicasTest() throws Exception{
        ...
        mockMvc.perform(get("/atenciones"))
                ...
                .andExpect(jsonPath("$._embedded.atencionMedicaList[0].fechaAtencion").value("2024-04-24"))
                ...
                .andExpect(jsonPath("$._embedded.atencionMedicaList[1].fechaAtencion").value("2024-04-24"))
